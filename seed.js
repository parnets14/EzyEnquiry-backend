...
async function main() {
  ...
  const { InventoryModel, WarehouseModel } = require('./src/models/Inventory')
  const { EnquiryModel }       = require('./src/models/Enquiry')
  const { OrderModel }         = require('./src/models/Order')
  const { DispatchModel }      = require('./src/models/Dispatch')
  ...
  const SupplierModel          = require('./src/models/Supplier')
  const { SaleModel }          = require('./src/models/Sale')
  const { ExpenseModel }       = require('./src/models/Expense')
  const { ReceivableModel, PayableModel, TransactionModel } = require('./src/models/Payment')
